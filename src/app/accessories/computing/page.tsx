...
export default function Computing() {
  ...
  const categoryData = categories.find(cat => cat.name === "Computing");
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Computing</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Essential computing accessories and peripherals for your devices.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="lg:w-1/4">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="mt-8">
                ...
                <div className="space-y-2">
                  {["Apple", "Samsung", "Dell", "Logitech", "Generic"].map((brand) => (
