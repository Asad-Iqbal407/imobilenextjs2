...
export default function SoundAudio() {
  const [selectedSubcategories, setSelectedSubcategories] = useState<string[]>([]);
  const [selectedPriceRange, setSelectedPriceRange] = useState<string[]>([]);
  const [selectedBrands, setSelectedBrands] = useState<string[]>([]);
  const [sortBy, setSortBy] = useState('featured');

  const categoryData = categories.find(cat => cat.name === "Sound & Audio");
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Sound & Audio</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Premium audio equipment and accessories for the best listening experience.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="lg:w-1/4">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="mt-8">
                ...
                <div className="space-y-2">
                  {["Sony", "JBL", "Audio-Technica", "Apple", "Generic"].map((brand) => (
